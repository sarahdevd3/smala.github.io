...
/////////////CONNEXION///////////////////
    ...
    case "login_check":
      ...
      break;
    case "logout":
      include("controller/ctrl.logout.php"); //Check si le log existe ou pas et si c'est un admin ou non
      break;
...
/////////////USER///////////////////
    case "espace_user":
      ...
      break;
    case "user_rud_photo":
      include("controller/ctrl.user_rud_photo.php"); //Gestionnaire de l'utilisateur
      break;
